...
public interface RedisConverter{
    ...
    MainRedisProductResponse convertMainRedisProductResponse(DeserializedRedisProduct deserializedRedisProduct);
    ...
    DeserializedRedisProductViewCountInformation convertDeserializedProductViewCountInformation(JsonNode jsonNode);
}
