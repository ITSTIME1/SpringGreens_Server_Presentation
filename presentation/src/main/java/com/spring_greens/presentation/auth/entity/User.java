...
public class User {
    ...
    @Builder
    public User(Long id, Role role, String email, String contact, String businessNumber, String name, boolean alertType, boolean termsType, boolean socialType, String socialName, String roadAddress, String addressDetails, String password) {
        this.id = id;
        this.role = role;
        this.email = email;
    ...
    /**
     * Updates the user's name if the provided email and socialType match the current email and socialType.
     */
